...
из-за того, что эта функция может выдавать бесконечность, этот метод очень тяжко оптимизировать. И поэтому нам приходится звать на помощь так называемый [[Lagrange multipliers]]!
