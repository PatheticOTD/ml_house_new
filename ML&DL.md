...
Для state value метода уравнения беллмана применяются каждый итеративно до тех пор, пока значения состояний перестанут отличаться на эпсилон. стоит отметить, что терминальные состояния всегда будут иметь 
