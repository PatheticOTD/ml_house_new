...
### RL
Reinforsment Learning - метод глубокого обучения который позволяет моделям учиться, взаимодействуя с окружающей средой. 

Цикл РЛ:
![[Pasted image 20250612173453.png]]

В научных статьях RL процесс называют [[Markov Decision Proces]].

Observations/States - это информация, которую получает агенте от среды (кадр, цена определенной акции и тд), однако:
- State - это полное описание состояния мира. 
- Observation - частичное.
*Action space* - набор действий в среде. делится на дискретный (конечный, например набор действий в игре марио) и неприрывный (бесконечный, например управление автомобилем)

[[Rewards and the Discounting]]

**Типы задач в обучении с подкреплением**:
1. [[Episodic]]
2. [[Continuing]]

Наконец, перед тем как взглянуть на методы решения проблем обучения с подкреплением следует рассмотреть [[Exploration Exploitation trade-off]].

Два главных способа решения проблем в рл [[Policy pi]].
